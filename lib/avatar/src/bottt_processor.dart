...
class BotttProcessor {
  List<BotttElement> _eyeCollection = EyeCollection().collection;
  List<BotttElement> _faceCollection = FaceCollection().collection;
  List<BotttElement> _mouthCollection = MouthCollection().collection;
  List<BotttElement> _sideCollection = SideCollection().collection;
  List<BotttElement> _textureCollection = TextureCollection().collection;
  List<BotttElement> _topCollection = TopCollection().collection;
