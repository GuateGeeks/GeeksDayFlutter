...
Map<String, String> getPartDescriptor(String stringParts) {
  if (stringParts.length == 12) {
    ...
    return pairs.toList().asMap().map((index, value) {
      return MapEntry(MultiAvatarPart.values[index].name, value);
    });
  } else {
    return {
      MultiAvatarPart.env.name: "00",
      MultiAvatarPart.clo.name: "00",
      MultiAvatarPart.head.name: "00",
      MultiAvatarPart.mouth.name: "00",
      MultiAvatarPart.eyes.name: "00",
      MultiAvatarPart.top.name: "00",
    };
  }
}
...
String multiavatar(String string,
  ...
  if (stringParts != null && parts == null) {
    parts = getPartDescriptor(stringParts);
  }
